...
public class FormControllerTests {
    ...
    public void init() {
        ...
        forms.add(form);
        page = new PageImpl(forms);
        Mockito.when(formRepository.findAllByStatusOrderByCreatedDateDesc(eq(Status.TO_DO), any(Pageable.class)))
                .thenReturn(page);
    }
    ...
    @Test
    @WithMockUser
    public void whenGetFormByStatus_shouldReturnOk() throws Exception {
        mockMvc.perform(get("/forms/").queryParam("status", "TO_DO"))
                .andExpect(status().isOk())
